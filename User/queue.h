/*
Simple queue / FIFO / circular buffer
Assumes a single producer, single consumer.
Assumes that index are atomic on the platform. No explicit syncronization
Typically used between an interrupt service routine (ISR) and the main thread.

MIT License. Copyright (c) 2017 Jordan S

From: https://github.com/JSchaenzle/c-message-queue/blob/master/queue.h
*/
