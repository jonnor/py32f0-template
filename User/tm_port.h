...
#define TM_MAX_CSIZE    (20)      //max channel num //used if INT8 mdl  //cost TM_MAX_CSIZE*4 Byte
#define TM_MAX_KSIZE    (5*5)       //max kernel_size   //cost TM_MAX_KSIZE*4 Byte
#define TM_MAX_KCSIZE   (3*3*100)   //max kernel_size*channels //cost TM_MAX_KSIZE*sizeof(mtype_t) Byte
...
#include <sys/time.h>
#include <time.h>
#define  TM_GET_US()       ((uint32_t)(HAL_GetTick()*1000))
